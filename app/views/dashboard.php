    ...
    <div class="col-lg-5">
        ...
        <div class="card border-0 shadow-sm mt-4">
            ...
            <div class="card-body d-grid gap-2">
                ...
                <a href="<?= BASE_URL ?>/usuarios/crear-profesor" class="btn btn-outline-primary">
                    <i class="bi bi-person-badge me-2"></i>Registrar docente
                </a>
                <?php endif; ?>
                <?php if ($_SESSION['user_rol'] === 'admin'): ?>
                <a href="<?= BASE_URL ?>/usuarios/crear-directivo" class="btn btn-outline-secondary">
                    <i class="bi bi-star me-2"></i>Registrar directivo
                </a>
                <?php endif; ?>
